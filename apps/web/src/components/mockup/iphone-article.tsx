          ...
          >
            ...
            <div className="bg-[#0f0f0f] px-5 pt-5 pb-20">
              ...
              <div className="flex items-center gap-2 mb-3">
                <span className="text-[10px] text-[#6366f1] bg-[#6366f1]/10 px-2 py-0.5 rounded-full">
                  {article.tag}
                </span>
              </div>
              ...
              <div className="flex items-center gap-2 mb-5 pb-4 border-b border-white/[0.06]">
                <div className="w-6 h-6 rounded-full bg-gradient-to-br from-[#6366f1] to-[#8b5cf6] flex items-center justify-center text-white text-[9px] font-bold">
                  DO
                </div>
