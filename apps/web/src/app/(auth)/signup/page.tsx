      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleVerify} className="space-y-4">
          <input
            ...
            maxLength={6}
            required
            className="w-full bg-white/[0.04] border border-white/[0.08] rounded-xl px-4 py-3 text-[22px] text-[#f5f3ee] text-center tracking-[0.3em] placeholder:text-[#6e6e6e] focus:outline-none focus:border-[#ff6b5c]/60 transition-all"
          />
      ...
      <form onSubmit={handleSignUp} className="space-y-4">
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input type="text" value={firstName} onChange={(e) => setFirstName(e.target.value)} placeholder="Ada" required className="w-full bg-white/[0.04] border border-white/[0.08] rounded-xl px-4 py-3 text-[14px] text-[#f5f3ee] placeholder:text-[#6e6e6e] focus:outline-none focus:border-[#ff6b5c]/60 focus:bg-white/[0.06] transition-all" />
          </div>
          <div>
            <label className="block text-[12px] text-[#8d8d8d] mb-2">Last name</label>
            <input type="text" value={lastName} onChange={(e) => setLastName(e.target.value)} placeholder="Lovelace" required className="w-full bg-white/[0.04] border border-white/[0.08] rounded-xl px-4 py-3 text-[14px] text-[#f5f3ee] placeholder:text-[#6e6e6e] focus:outline-none focus:border-[#ff6b5c]/60 focus:bg-white/[0.06] transition-all" />
          </div>
        </div>

        <div>
          <label className="block text-[12px] text-[#8d8d8d] mb-2">Email</label>
          <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@example.com" required className="w-full bg-white/[0.04] border border-white/[0.08] rounded-xl px-4 py-3 text-[14px] text-[#f5f3ee] placeholder:text-[#6e6e6e] focus:outline-none focus:border-[#ff6b5c]/60 focus:bg-white/[0.06] transition-all" />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input type="text" value={username} onChange={(e) => setUsername(e.target.value.toLowerCase().replace(/[^a-z0-9_]/g, ""))} placeholder="adalovelace" required className="w-full bg-white/[0.04] border border-white/[0.08] rounded-xl pl-8 pr-4 py-3 text-[14px] text-[#f5f3ee] placeholder:text-[#6e6e6e] focus:outline-none focus:border-[#ff6b5c]/60 focus:bg-white/[0.06] transition-all" />
          </div>
        </div>
        ...
        <button type="submit" disabled={!isLoaded || loading} className="w-full py-3 rounded-xl bg-[#ff6b5c] text-white text-[14px] font-medium hover:bg-[#e8513f] transition-colors mt-1 disabled:opacity-50 disabled:cursor-not-allowed">
