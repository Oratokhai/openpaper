    ...
    <div className="w-full max-w-sm">
      ...
      <form onSubmit={handleEmailSignIn} className="space-y-4">
        ...
        <button
          ...
          className="w-full py-3 rounded-xl bg-[#6366f1] text-white text-[14px] font-medium hover:bg-[#5457e0] transition-colors mt-1 disabled:opacity-50 disabled:cursor-not-allowed"
        >
