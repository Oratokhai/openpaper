...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center text-center px-6">
      <p className="text-[#6366f1] text-[64px] leading-none mb-4" style={{ fontFamily: "var(--font-fraunces)" }}>
        404
      </p>
      ...
      <div className="flex items-center gap-3">
        <Link href="/home" className="px-5 py-2.5 rounded-xl bg-[#6366f1] text-white text-sm font-medium hover:bg-[#5457e0] transition-colors">
          Go home
        </Link>
