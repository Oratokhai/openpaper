          ...
          {articles.length > 0 ? (
            ...
            <div className="text-center py-16 px-6 rounded-2xl border border-dashed border-white/[0.08]">
              ...
              <p className="text-[#858585] text-sm mb-6 max-w-sm mx-auto">
                ...
                <span className="text-[#ff9a8f]">@{model.name}</span> in any article and it
                shows up here.
              </p>
              <Link
                href="/write"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#ff6b5c] text-white text-sm font-medium hover:bg-[#e8513f] transition-colors"
              >
